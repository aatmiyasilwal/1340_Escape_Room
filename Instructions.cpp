...
int main() {
    ...
    instructions.push_back("- Use arrow keys to move & press 'a' to interact with doors in the main lobby and items within rooms.\n");
    ...
    instructions.push_back("- Interacting with room doors will promt you with a loading page, press 'ENTER' to continue.\n");
